...
const Transaction = () => {
   ...
   const date = (params, render = false) => {
   ...
   return (
      <ScrollView className="h-full bg-white px-4">
         ...
         {/* Header */}
         <View className="header py-4 flex-row justify-between items-center">
            <TouchableHighlight
               activeOpacity={0.99}
               underlayColor="#eee"
         ...
         <View className="financial-report flex-row justify-between items-center my-2 bg-[#EEE5FF] rounded-lg px-4 py-3.5 ">
            <Text className="text-base text-violet-100">See your financial report</Text>
