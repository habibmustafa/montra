...
import { Dimensions, FlatList, ScrollView, StatusBar, Text, TouchableWithoutFeedback, View } from "react-native";
   ...
   return (
      <ScrollView className="h-full bg-white">
         ...
         <View>
            ...
            {/* Amount */}
            <Text className="mb-3 mt-5 px-5 font-bold text-[32px] text-black">₼ 332</Text>
            <Chart data={[3, 5, 4, 7, 4, 8]} />
         </View>
         ...
         <View className="px-4 mt-6">
            ...
            <View className="flex-row justify-between items-center">
               ...
               <View className="p-1 border border-light-60 rounded-lg">
